...
|------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|----------------------------------------|
| [`gen_coldiff()`](https://gvelasq.github.io/mutagen/reference/gen_coldiff.md)                  | `as.integer(any(imap_lgl(data[-1], \(x, idx) !identical(data[[1]], data[[idx]]))))` | `egen diff()`                          |
...
14. Parallelization is supported via
    [purrr::in_parallel()](https://purrr.tidyverse.org/reference/in_parallel.html).
