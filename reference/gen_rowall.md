...
This function performs a rowwise match of all supplied values across
columns in a data frame. If all of the row values equal one of the
...
A binary integer vector indicating whether all supplied values were
