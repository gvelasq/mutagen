...
Thanks for using mutagen! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/gvelasq/mutagen/issues/new).
...
requests](https://github.com/gvelasq/mutagen/issues) to make sure the
...
To be as efficient as possible, development of the mutagen package tends
