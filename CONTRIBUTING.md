...
This outlines how to propose a change to mutagen. For a detailed
discussion on contributing to this and other packages, please see the
tidyverse team’s [development contributing
...
help you write a unit test, if needed). See the tidyverse team’s guide
on [how to create a great
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("gvelasq/mutagen", fork = TRUE)`.
