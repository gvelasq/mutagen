...
>
> -- [*The R Inferno*](https://www.burns-stat.com/documents/books/the-r-inferno) *(Patrick Burns, 2011)*
...
[^2]: Parallelization is supported via [purrr::in_parallel()](https://purrr.tidyverse.org/reference/in_parallel.html).
